...
#! twiiter: @gaidhane_uday ------------
#! Github: udaygaidhane30 -------------
#! LinkedIn: Uday Gaidhane ------------
# -------------------------------------
# -------------------------------------
# IMPORT LIBRARIES
# ----------------
...
def socials_contr():
    github_angel = 'https://github.com/udaygaidhane30'
    # personal_ws_angel = ''
    linkedin_angel = 'https://www.linkedin.com/in/udaygaidhane/'
    twitter_angel = 'https://twitter.com/gaidhane_uday'
    SC_Cont = f'''
    - Angel Santana (creator of application)
        - Github: [udaygaidhane30]({github_angel})        
        - LinkedIn: [Uday Gaidhane]({linkedin_angel})
        - Twitter: [gaidhane_uday]({twitter_angel})
...
<div class="footer">
<p>Developed by Uday Gaidhane</p>
</div>
"""
